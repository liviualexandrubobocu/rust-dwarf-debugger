...
pub fn parse_wasm(wasm_contents: &[u8],  object: &object::File,
                  endian: gimli::RunTimeEndian) -> Result<()> {
...
fn handle_dwarf_section(name: &str, data: &[u8], object: &object::File, endianness: gimli::RunTimeEndian) -> Result<()> {
    match name {
        ".debug_info" => {
